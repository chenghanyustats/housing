...
```{r}
#| label: function-get_former_communes
...
```{r}
#| label: function-get_current_communes
...
```{r}
#| label: function-get_test_communes
...
```{r}
#| label: function-make_country_level_data
...
```{r}
#| label: function-make_commune_level_data
